...
> For this set of experiments, we assume data is symmetric across all clients (i.e., i.i.d. and e.d. setting) and vary
> the number of dataset partitions i.e.,total clients 𝑧 = {15, 30, 60, 90, 120, 150, 190, 230, 260, 300, 330, 360, 400}. Therefore the data to model ratio
> becomes 𝑟_𝑑𝑎𝑡𝑎_𝑖 = 𝑑∕(𝑚 ⋅ 𝑧), ∀𝑖 ∈ [1, 𝑧] (see Section 3.3). We also, for now, assume a constant value for the per round participants 𝑘 = 5.
