...
sed -i -e 's/# ingress_nginx_service_nodeport_http: 30080/ingress_nginx_service_nodeport_http: 30080/g' ./inventory/dynamos/group_vars/k8s_cluster/k8s-cluster.yml
sed -i -e 's/# ingress_nginx_service_nodeport_https: 30081/ingress_nginx_service_nodeport_https: 30443/g' ./inventory/dynamos/group_vars/k8s_cluster/k8s-cluster.yml
