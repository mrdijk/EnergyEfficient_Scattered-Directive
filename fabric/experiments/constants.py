...
LEARNING_RATE = 0.01
DATA_PROVIDERS =  ["server", "client1", "client2", "client3", "client4", "client5", "client6", "client7", "client8", "client9", "client10"]
...
HFL_REQUEST = {
    ...
    "dataProviders": ["server", "client1", "client2", "client3", "client4", "client5", "client6", "client7", "client8", "client9", "client10"],
    "data_request": {
        "type": "hflTrainModelRequest",
        "data": {},
        "requestMetadata": {}
